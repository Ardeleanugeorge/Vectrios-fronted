...
export default function DashboardPage() {
  ...
  // Trial expired check
  const isTrialExpired = currentPlan === null && !subscriptionLoading
  const isTrialActive = monitoringStatus?.source !== undefined
        ...
        <main className="py-12">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <div className="rounded-2xl border border-amber-500/40 bg-amber-50 p-10">
              ...
              <p className="text-gray-600 mb-8">Upgrade to continue monitoring your revenue architecture and keep access to all insights.</p>
