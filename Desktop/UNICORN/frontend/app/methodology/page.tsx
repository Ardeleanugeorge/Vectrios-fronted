      ...
      <main className="py-12">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <section className="mb-16">
            ...
            <ul className="space-y-3 text-lg text-gray-600 mb-8 ml-6">
          ...
          <section id="revenue-impact-index" className="mb-16 border-t border-gray-200 pt-12 scroll-mt-24">
            ...
            <div className="space-y-6 mb-8">
              <div>
                ...
                <p className="text-gray-600">Does messaging reinforce the revenue objective?</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-cyan-400 mb-2">ICP Signal Clarity</h3>
                <p className="text-gray-600">Is the ideal customer profile consistently represented?</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-cyan-400 mb-2">Conversion Anchor Density</h3>
                <p className="text-gray-600">Are measurable outcomes embedded in messaging?</p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-cyan-400 mb-2">Positioning Coherence</h3>
                <p className="text-gray-600">Does narrative structure maintain continuity?</p>
              </div>
            </div>
            ...
            <p className="text-lg text-gray-700 mb-4 leading-relaxed">
              ...
              ): a <span className="text-gray-700">0–100</span> score summarizing structural revenue-stage risk from your crawl.
