          ...
          {scanCount !== null && scanCount > 0 && (
            <div className="flex items-center justify-center">
              ...
              >
                ...
                <span className="font-semibold text-slate-600 group-hover:text-slate-900 dark:text-gray-300 dark:group-hover:text-gray-900 transition-colors">
            ...
            <div className="p-4 sm:p-5">
              ...
              <div className="mt-4 flex flex-wrap gap-2 sm:gap-3">
                <button
                  ...
                  className="px-4 py-2 rounded-lg border border-gray-600 text-gray-200 hover:border-cyan-500/50 hover:text-gray-900 text-sm"
                >
