...
export default function RevenueRiskTrajectoryPanel({ companyId }: RevenueRiskTrajectoryPanelProps) {
  ...
  if (loading) {
    return (
      <div className="p-8 bg-gray-50 rounded-lg border border-gray-200">
        <h2 className="text-xl font-bold mb-6 uppercase tracking-wide text-gray-900">Structural Risk Outlook</h2>
  ...
  return (
    <div className="p-8 bg-gray-50 rounded-lg border border-gray-200">
      <h2 className="text-xl font-bold mb-2 uppercase tracking-wide text-gray-900">Structural Risk Outlook</h2>
